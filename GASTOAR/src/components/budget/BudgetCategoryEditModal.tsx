    ...
    <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-xs flex items-center justify-center p-3 sm:p-4 animate-in fade-in duration-150">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 shrink-0">
          <div className="bg-slate-100 p-1 rounded-xl flex items-center gap-1 text-xs font-bold border border-slate-200 w-full sm:w-auto">
            <button
              type="button"
          ...
          {activeMode === 'subcategories' && (
            <div className="flex items-center gap-1 text-xs overflow-x-auto pb-0.5 sm:pb-0 scrollbar-none w-full sm:w-auto justify-start sm:justify-end">
              <button
                type="button"
                onClick={handleCopyAllRealExpenses}
                className="px-2.5 py-1 text-[11px] font-bold text-slate-700 bg-slate-100 hover:bg-purple-50 hover:text-[#7928CA] rounded-lg transition-colors cursor-pointer whitespace-nowrap shrink-0"
              ...
              <button
                ...
                className="px-2 py-1 text-[11px] font-bold text-slate-400 hover:text-rose-600 rounded-lg transition-colors cursor-pointer shrink-0"
                        ...
                        <div className="flex items-center justify-between sm:justify-end gap-2 w-full sm:w-auto">
                          {spent > 0 && val === 0 && (
                            <button
                              ...
                              className="px-2 py-1 bg-white border border-purple-200 text-[#7928CA] rounded-lg text-[10px] font-bold hover:bg-purple-50 transition-colors cursor-pointer shrink-0"
                          ...
                          <div className="relative w-36 ml-auto sm:ml-0">
        ...
        <div className="pt-3 border-t border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-3 shrink-0">
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto justify-end">
            <button
              type="button"
              onClick={onClose}
              className="flex-1 sm:flex-initial px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-bold rounded-xl transition-colors cursor-pointer text-center"
            >
              Cancelar
            </button>
            <button
              type="button"
              onClick={handleSave}
              className="flex-1 sm:flex-initial px-5 py-2 bg-gradient-to-r from-[#7928CA] to-[#9d4edd] hover:opacity-95 text-white text-xs font-bold rounded-xl shadow-md transition-all flex items-center justify-center gap-1.5 active:scale-95 cursor-pointer"
            >
